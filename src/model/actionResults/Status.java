...
public enum Status {
    ...
    HEALTH_INCREASED("Gained health..."),
    MANA_INCREASED("Gained mana..."),
    STATS_INCREASED("Gained some more attack and defense..."),
    STATS_DECREASED("Lost some attack and defense..."),
    GAME_OVER("You died...");
